                        ...
                        <form method="POST" action="{{ route('clients.store') }}" id="form-clients">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-xl-5 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nickname" name="nickname" value="{{old('nickname')}}" required autofocus >
                                        @error('nickname')
                                            <div class="invalid-feedback">{{ $message }}</div> 
                                        @enderror
                                    </div>
                                    <div class="col-xl-3 mb-3">
                                        ...
                                        <input type="date" class="form-control" id="birth_date" name="birth_date" value="{{old('birth_date')}}" autofocus >
                                        @error('birth_date')
                                            <div class="invalid-feedback">{{ $message }}</div> 
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-xl-3 mb-3">
                                        <label>{{ __('RG') }}</label>
                                        <input type="tel" class="form-control" id="rg" name="rg" value="{{old('rg')}}" autofocus >
                                        @error('rg')
                                            <div class="invalid-feedback">{{ $message }}</div> 
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-xl-3 mb-3">
                                        <label>{{ __('CPF') }}</label>
                                        <input type="tel" class="form-control" id="cpf" name="cpf" value="{{old('cpf')}}" autofocus >
                                        @error('cpf')
                                            <div class="invalid-feedback">{{ $message }}</div> 
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-xl-3 mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="phone" name="phone" value="{{old('phone')}}" autofocus >
                                        @error('phone')
                                            <div class="invalid-feedback">{{ $message }}</div> 
                                        @enderror
                                    </div>
                                    <div class="col-xl-3 mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="phone_home" name="phone_home" value="{{old('phone_home')}}" autofocus >
                                        @error('phone_home')
                                            <div class="invalid-feedback">{{ $message }}</div> 
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-xl-3 mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="email" name="email" value="{{old('email')}}" autofocus >
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div> 
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-xl-3 mb-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select form-control" name="type" id="type">
                                                ...
                                                <option value="responsavel"{{ old('type') === 'responsavel' ? ' selected' : '' }}>Responsável</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="height" id="height" value="{{ old('height') }}" placeholder="Ex: 175">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="weight" id="weight" value="{{ old('weight') }}" placeholder="Ex: 70">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-xl-3 mb-3">
                                        ...
                                        <input type="text" name="complements" id="complements" class="form-control" value="{{ old('complements') }}">
                                    </div>
