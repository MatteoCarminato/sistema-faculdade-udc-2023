<!-- MODAL - CADASTRAR ESTADOS -->
@include('private.clients.modal.modal_create_state')
<!-- MODAL - CADASTRAR ESTADOS -->
        ...
        <div class="modal-content modal-content-demo">
            ...
            <form method="GET">
                <div class="row"> 
                    ...
                    <button class="modal-effect input-group-text" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#modal_create_state"> Cadastrar </button>
                    </div>
                </div>
            </form>
...
$(document).ready(function() {
        ...
        success: function(response) {
            ...
            response.data.forEach(function(states) {
                tbody.append(`<tr>
                                <td>${states.name}</td>
                                <td>
                                <button type="button" class="btn btn-primary select-btn-state-form" data-value="${states.id}" data-name="${states.name}" data-bs-dismiss="modal" >
                                            Selecionar
                                        </button>
                                        </td>
                            </tr>`);
    ...
    $(document).on('click', '.select-btn-state-form', function() {
