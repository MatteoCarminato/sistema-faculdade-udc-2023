<!-- MODAL - CADASTRAR PAIS -->
@include('private.clients.modal.modal_create_country')
<!-- MODAL - CADASTRAR PAIS -->
                    ...
                    <form method="GET">
                        <div class="row"> 
                            ...
                            <div class="col-3 col-md-3">
                                <button class="modal-effect input-group-text" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#modal_create_country"> Cadastrar </button>
                            </div>
                        </div>
                    </form>
...
$(document).ready(function() {
        ...
        success: function(response) {
            ...
            response.data.forEach(function(countries) {
                tbody.append(`<tr>
                                ...
                                <td>
                                <button type="button" class="btn btn-primary select-btn-modal-country-form" data-value="${countries.id}" data-name="${countries.name}" data-toggle="modal" data-target="#modal" >
                                            Selecionar
                                        </button>
                                        </td>
                            </tr>`);
    ...
    $(document).on('click', '.select-btn-modal-country-form', function() {
