<div class="modal fade" id="modal_create_categories">
    <div class="modal-dialog modal-dialog-centered text-center modal-xl" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ __('Cadastrar Categoria') }}</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
    ...
    $('#category-form').submit(function (event) {
        ...
        $.ajax({
            ...
            success: function (response) {
                $('#modal_categories_form').modal('show');
            },
