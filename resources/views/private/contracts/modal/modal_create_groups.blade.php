<div class="modal fade" id="modal_create_groups">
    <div class="modal-dialog modal-dialog-centered text-center modal-xl" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ __('Cadastrar Aluno') }}</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
...
$(document).ready(function () {
    $('#groups-form').submit(function (event) {
        ...
        $.ajax({
            ...
            success: function (response) {
                $('#modal_groups_form').modal('show');
            },
            error: function (xhr, status, error) {
                $('#modal_groups_form').modal('show');
           }
        });
        $('#modal_create_groups').modal('hide');
    });
});
