                            ...
                            <tr>
                                ...
                                <td class="td-actions text-right">
                                    <form action="{{ route('contracts.destroy', $contract->id) }}" method="post">
                                        @csrf
                                        @method('delete')
                                        <a class="btn btn-primary" href="{{ route('contracts.show', $contract->id) }}" data-original-title="" title="">
                                            <i class="material-icons">Ver</i>
                                            <div class="ripple-container"></div>
                                        </a>
                                        <a class="btn btn-warning" href="{{ route('contracts.edit', $contract->id) }}" data-original-title="" title="">
