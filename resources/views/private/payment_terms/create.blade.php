                ...
                <div class="row">
                    <div class="card-body">
                        ...
                        @csrf    
                            ...
                            <button class="btn btn-primary" id="btnSalvarForm" type="submit">{{ __('Salvar') }}</button>
                        </form>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
  ...
  $('#btnSalvarForm').on('click', function() {
        ...
        $('#tblDados tbody tr').each(function(row, tr) {
            ...
            data.push({qnt: qnt, dias: dias, porcentual: porcentual, forma_pagamento: forma_pagamento, codFormaPagamento: codFormaPagamento});
        });
