    ...
    <div class="modal-dialog modal-dialog-centered text-center modal-xl" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ __('Cadastrar Estado') }}</h6><button aria-label="Close" class="btn-close"
                        ...
                        <div class="form-row">
                            <div class="col-xl-3 col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="modal-effect input-group-text" data-bs-effect="effect-super-scaled"
                                        data-bs-toggle="modal" href="#modal_country_form"> <i class="fa fa-search"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-3">
