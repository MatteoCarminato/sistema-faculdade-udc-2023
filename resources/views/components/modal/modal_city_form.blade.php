{{-- Modal --}}
@include('components.modal.modal_client_create_city_form')
{{-- Modal --}}
        ...
        <div class="modal-content modal-content-demo">
            ...
            <form method="GET">
                <div class="row"> 
                    ...
                    <button class="modal-effect input-group-text" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#modal_client_create_city_form"> Cadastrar </button>
                    </div>
                </div>
            </form>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.select-btn', function() {
        ...
        $('#modal_client_create_city_form').modal('hide');
    });
