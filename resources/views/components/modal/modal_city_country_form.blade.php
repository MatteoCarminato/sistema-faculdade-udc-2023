                    ...
                    <form method="GET">
                        <div class="row"> 
                            ...
                            <div class="col-3 col-md-3">
                                <button class="modal-effect input-group-text" data-bs-effect="effect-super-scaled" data-bs-toggle="modal" href="#modal_create_country_form"> Cadastrar </button>
                            </div>
                        </div>
                    </form>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.select-btn', function() {
        ...
        $('#modal_city_create_state_form').modal('show');
    });
